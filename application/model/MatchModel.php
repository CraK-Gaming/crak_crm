...
class MatchModel
{
    public static function getLatestMatches()
    {
        ...
        $sql = "SELECT match_id, match_date, matches.description as match_description, matches.match_status_id, match_status.status as match_status_name,
						teams.team_id, teams.name as team_name, games.name as game_name,
